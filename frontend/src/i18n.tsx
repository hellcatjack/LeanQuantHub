...
const messages: Record<Locale, MessageTree> = {
  zh: {
    ...
    data: {
      ...
      ib: {
        title: "IB 交易连接",
        meta: "配置 IB Gateway/TWS 连接与行情模式",
        status: "连接状态",
        lastHeartbeat: "最后心跳",
        stateUpdated: "状态更新时间",
        message: "状态消息",
        ...
        clientId: "客户端 ID",
        clientIdHint: "IB API clientId，避免与其他会话冲突",
        accountId: "账户号",
        accountIdPlaceholder: "如需指定账户可填写",
        accountIdHint: "已配置账户 {account}",
        apiMode: "数据源模式",
        apiModeHint: "开发期可用 Mock 模式替代 IB API",
        apiModeIb: "IB 实盘",
        apiModeMock: "Mock 模拟",
        ...
        healthSymbolsHint: "用于检查 IB 行情可用性（无订阅时可回退历史）",
        ...
        historyEmpty: "暂无历史任务",
        streamTitle: "IB 行情订阅",
        streamMeta: "订阅 IB L1 行情并持续写入 stream 文件",
        streamStatus: "订阅状态",
        ...
        saved: "已保存 IB 连接配置",
        loadError: "读取 IB 配置失败",
        saveError: "保存 IB 配置失败",
      },
      tradingCalendar: {
        title: "交易日历配置",
  ...
  en: {
    ...
    data: {
      ...
      ib: {
        title: "IB Connection",
        meta: "Configure IB Gateway/TWS connection & market data mode",
        ...
        healthSymbolsHint: "Check IB market availability (fallback to history if needed)",
        ...
        streamTitle: "IB Stream",
        streamMeta: "Subscribe IB L1 stream and write ticks to stream files",
        ...
        saved: "IB settings saved",
        loadError: "Failed to load IB settings",
        saveError: "Failed to save IB settings",
      },
    },
    trade: {
      title: "Live Trading",
      meta: "IB execution status and runtime overview",
      overviewTitle: "Connection Overview",
      overviewMeta: "Aggregated IB connection and execution health",
      ...
      accountSummaryMeta: "Core funding fields and full tag browsing",
      accountSummaryUpdatedAt: "Updated at",
      ...
      accountSummaryFullEmpty: "No full tags",
      ...
      accountPositionsMeta: "Holdings and valuation fields",
      accountPositionsUpdatedAt: "Updated at",
      accountPositionsEmpty: "No positions",
