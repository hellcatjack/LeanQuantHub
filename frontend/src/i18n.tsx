  ...
  zh: {
    ...
    projects: {
      ...
      config: {
        ...
        riskFreeRate: "无风险利率",
        initialCash: "回测初始资金",
        initialCashHint: "留空则继承全局默认",
        feeBps: "回测手续费(bps)",
        feeBpsHint: "留空则继承全局默认",
    ...
    strategy: {
      ...
      decision: {
        ...
        backtestRunId: "回测 Run ID",
        backtestRunIdHint: "可选，指定回测追溯来源",
        preview: "预览决策",
        run: "生成快照",
        empty: "暂无决策快照",
        source: "来源",
        ...
        cashWeight: "现金占比",
        maxExposure: "最大敞口",
        backtestLinkStatus: "回测关联",
        backtestUnlinked: "未绑定回测",
        scorePath: "评分文件",
        filterStats: "过滤原因分布",
        tabSelected: "入选",
        tabFiltered: "被过滤",
      ...
      pipeline: {
        ...
        backtest: {
          ...
          hints: {
            ...
            riskOffLookbackDays: "防御动量回看窗口(天)",
            ...
            coldStartTurnover: "冷启动(初始空仓)时的换手上限",
            volTarget: "目标波动率上限",
            volWindow: "波动率估计窗口(天)",
    ...
    data: {
      ...
      excludes: {
        title: "全局排除列表",
        meta: "统一排除 PreTrade / 回测 / 实盘 / 数据同步中的标的",
        hint: "排除清单会在各任务中自动生效",
        add: "添加",
        save: "保存",
        enable: "启用",
        ...
        error: "排除列表加载失败",
        errorSymbol: "请输入标的代码",
        placeholderSymbol: "如 AAPL",
        placeholderReason: "排除原因",
        filter: {
          label: "展示范围",
          all: "全部",
          enabled: "仅启用",
      ...
      backtest: {
        settings: {
          title: "回测默认参数",
          meta: "全局默认初始资金与手续费，项目可覆盖",
          initialCash: "默认初始资金",
          initialCashHint: "例如 30000",
          feeBps: "默认手续费(bps)",
          feeBpsHint: "例如 10",
          settingsSaved: "回测默认参数已保存",
          settingsLoadError: "读取回测默认参数失败",
          settingsSaveError: "保存回测默认参数失败",
          settingsInvalidCash: "初始资金必须为正数",
          settingsInvalidFee: "手续费必须为非负数",
          updatedAt: "更新时间 {at}",
        },
      },
      pretrade: {
        ...
        steps: {
          ...
          bridge_gate: "Lean Bridge 交易门禁",
          market_snapshot: "交易行情快照",
          trade_execute: "交易执行",
          audit: "验收审计",
        },
        stepsDesc: {
          ...
          bridge_gate: "校验 Lean Bridge 心跳/账户/持仓/行情是否就绪",
          market_snapshot: "交易前行情快照（Lean Bridge）",
          trade_execute: "执行交易批次（Paper/Live）",
          audit: "全量数据审计与覆盖检查",
        },
        stepsGroup: {
          data: "数据准备",
          ...
          trade: "交易门禁/执行",
          tradeHint: "Lean Bridge 就绪检查与下单执行",
          audit: "审计/回退",
          auditHint: "交易后验收与回退记录",
          other: "其他步骤",
          otherHint: "模板包含的扩展步骤",
        },
        settings: {
      ...
      ib: {
        ...
        workstationTypeHint: "选择连接端类型：TWS 或 IB Gateway",
        workstationTypeTws: "TWS",
        workstationTypeGateway: "IB Gateway",
        clientId: "客户端 ID",
    ...
    trade: {
      ...
      pipeline: {
        ...
        detailMeta: "时间轴与节点详情",
        drawerTitle: "事件详情",
        drawerEmpty: "选择事件查看详情",
        drawerLabelType: "类型",
        drawerLabelId: "ID",
        drawerLabelStatus: "状态",
        drawerLabelError: "错误码",
        drawerLabelLog: "日志路径",
        drawerLabelTags: "标签",
        empty: "暂无 Pipeline 运行",
        detailEmpty: "请选择 Run 查看事件",
        projectRequired: "请先选择项目",
        stages: {
          data: "数据准备",
          snapshot: "评分/快照",
        ...
        actions: {
          ...
          resumeRun: "恢复运行",
          executeTrade: "执行交易",
          retryStepSuccess: "已触发步骤重试",
          resumeSuccess: "已触发运行恢复",
          executeSuccess: "已触发交易执行",
        },
        errors: {
          loadRuns: "Pipeline 列表加载失败",
          loadDetail: "Pipeline 详情加载失败",
          actionFailed: "Pipeline 操作失败",
        },
      },
      mainSectionTitle: "核心信息",
      advancedSectionTitle: "高级功能区",
      refreshAll: "刷新全部",
      statusExplainTitle: "状态说明",
      statusExplainConnection: "连接状态",
      statusExplainDataSource: "数据源状态",
      statusExplainRefresh: "刷新结果",
      statusExplainHeartbeatAge: "心跳年龄 {seconds}s",
      statusExplainLastHeartbeat: "心跳时间 {time}",
      statusExplainLastRefresh: "上次刷新 {time}",
      statusExplainNextAllowed: "下次允许刷新 {time}",
      statusReason: {
        bridgeStale: "Lean Bridge 心跳超时",
        bridgeIssue: "Lean Bridge 异常",
        unknown: "未知原因",
      },
      refreshHint: {
        rateLimited: "刷新过于频繁，系统已触发节流保护。",
        fresh: "当前状态新鲜，无需刷新。",
        failed: "刷新失败，请稍后重试。",
        generic: "刷新结果：{result}（原因：{reason}）。",
      },
      ...
      refreshLast: "上次刷新",
      refreshManual: "手动",
      bridgeStatusTitle: "Lean Bridge 状态",
      bridgeStatusMeta: "桥接心跳与刷新控制",
      bridgeStatusLabel: "桥接状态",
      bridgeHeartbeatAt: "最近心跳",
      bridgeStaleLabel: "是否过期",
      bridgeLastRefreshAt: "最近刷新",
      bridgeRefreshResultLabel: "刷新结果",
      bridgeRefreshReasonLabel: "刷新原因",
      bridgeRefreshMessageLabel: "刷新提示",
      bridgeLastError: "最新错误",
      bridgeRefreshButton: "刷新 Lean Bridge",
      bridgeRefreshRunning: "刷新中",
      bridgeAutoRefreshOn: "自动刷新：开",
      bridgeAutoRefreshOff: "自动刷新：关",
      bridgeStatusLoadError: "桥接状态加载失败",
      gatewayRuntimeLabel: "Gateway 运行状态",
      gatewayProbeResultLabel: "直连探针",
      gatewayProbeLatencyLabel: "探针延迟",
      gatewayProbeLatencyValue: "{value} ms",
      gatewayRecoveryActionLabel: "最近恢复动作",
      gatewayRecoveryAtLabel: "最近恢复时间",
      gatewayNextRecoveryLabel: "下次允许恢复",
      ...
      gatewayRuntimeState: {
        ...
        snapshot_stale: "快照停滞",
        command_stuck: "命令积压",
        bridge_degraded: "Bridge 降级",
        gateway_degraded: "Gateway 降级",
        gateway_restarting: "Gateway 重启中",
        recovering: "恢复中",
        unknown: "未知",
      },
      gatewayProbeResult: {
      ...
      gatewayRecoveryAction: {
        none: "无",
        bridge_refresh: "刷新 Bridge",
        leader_restart: "重启 Leader",
        gateway_restart: "重启 Gateway",
        gateway_degraded: "进入降级保护",
      },
      gatewayTradeBlock: {
        gateway_restarting: "IB Gateway 正在自动重启，暂时禁止新批次与新订单。",
        gateway_degraded: "IB Gateway 仍处于降级状态，暂时禁止新批次与新订单。",
      },
      bridgeRefreshResult: {
        success: "成功",
        failed: "失败",
      ...
      bridgePoolTitle: "Lean Bridge 执行器池",
      bridgePoolMeta: "Leader/Worker 常驻实例概览",
      bridgePoolMode: "运行模式",
      bridgePoolRefresh: "刷新池状态",
      bridgePoolEmpty: "暂无执行器数据",
      bridgePoolError: "执行器池状态加载失败",
      bridgePoolColumns: {
        role: "角色",
        clientId: "Client ID",
        status: "状态",
      ...
      marketHealthTitle: "行情源健康",
      marketHealthMeta: "行情源连接与快照质量概览",
      marketHealthStatus: "健康状态",
      marketHealthUpdatedAt: "心跳时间",
      snapshotTitle: "行情快照",
      ...
      statusTitle: "{system} 状态",
      statusMeta: "{system}/IB 连接与配置状态",
      statusLabel: "{system} 状态",
      ...
      accountPositionsStaleHint:
        "持仓为空且数据已过期，可能是 Lean Bridge 未更新。请检查 Lean 运行状态或使用“刷新全部”。",
      accountPositionsStaleUpdatedAt: "Bridge 最近心跳",
      accountPositionsTrustedFallbackHint:
        "当前展示最后一次可信持仓。Gateway 仍在恢复，或本次持仓刷新失败。",
      accountPositionsTrustedAt: "最后可信时间",
      accountPositionsRefresh: "刷新持仓",
      positionChartTitle: "专业图表",
      positionChartSelectPrompt: "点击左侧持仓标的以查看历史 K 线。",
      ...
      positionActionSelected: "已选 {count} 项",
      positionActionSelectAll: "全选持仓",
      positionActionSelectSymbol: "选择 {symbol}",
      positionActionBuy: "买入",
      positionActionSell: "卖出",
      positionActionClose: "平仓",
      positionActionQtyShort: "数量",
      positionActionSessionShort: "时段",
      positionActionTypeShort: "类型",
      positionActionLimitShort: "限价",
      positionActionLimitShortPlaceholder: "最新价",
      positionActionLimitDisabledTitle: "仅限价类订单可编辑",
      positionActionBatchClose: "批量平仓",
      positionActionLiquidateAll: "全仓清空",
      manualSession: {
        rth: "常规时段",
        pre: "盘前",
        post: "盘后",
      ...
      positionActionErrorInvalidQty: "请输入有效数量。",
      positionActionErrorInvalidLimitPrice: "请输入有效限价，或先刷新行情。",
      directOrderProjectRequired: "直发订单需要先选择项目。",
      positionActionResult: "已提交 {count} 笔订单。",
      openData: "前往数据配置",
      refresh: "刷新状态",
      ...
      snapshotNotReady: "快照未就绪（{status}），请等待生成成功后再执行。",
      snapshotDate: "快照日期",
      snapshotId: "快照 ID",
      snapshotLoadError: "快照加载失败",
      decisionBasisTitle: "决策基础数据标志",
      decisionBasisMeta: "明确当前批次决策所使用的 PIT 日期与回退信息",
      decisionBasisSnapshotId: "决策快照 ID",
      decisionBasisSnapshotDate: "决策快照日期",
      decisionBasisRequestedPitDate: "请求 PIT 日期",
      decisionBasisEffectivePitDate: "实际采用 PIT 日期",
      decisionBasisLatestPitDate: "最新可用 PIT 日期",
      decisionBasisFallbackUsed: "是否触发 PIT 回退",
      decisionBasisFallbackReason: "PIT 回退原因",
      decisionBasisStaleWarning: "快照时效告警",
      decisionBasisAgeDays: "PIT 时效（天）",
      decisionBasisStaleThreshold: "阈值 {days} 天",
      decisionBasisAsOfTime: "决策时点",
      decisionBasisNoFallback: "未触发回退",
      decisionBasisAgeDaysShort: "{days} 天",
      decisionBasisSummaryLine:
      ...
      weeklyRebalance: {
        title: "周度自动调仓",
        meta: "查看定时器、PreTrade 检查与交易批次链路，并允许手工发起。",
        force: "强制忽略日期/时段保护",
        dryRun: "执行时仅演练",
        projectRequired: "请先选择项目。",
        loadError: "周度调仓状态加载失败",
        actionError: "周度调仓手工触发失败",
        confirmExecute: "确认手工执行周度调仓交易批次？该操作会提交执行链路。",
        manualPrepare: "手工运行 PreTrade",
        manualExecute: "手工执行交易",
        actionResult:
          "{phase} 返回 {status} · PreTrade {pretrade} · 交易 {trade} · {message}",
        updatedAt: "状态刷新 {at}",
        phase: {
          prepare: "PreTrade",
          execute: "执行",
      ...
      deadbandRunWeightHint: "留空继承全局默认；填写后仅作用于本批次。",
      deadbandRunPlaceholder: "留空继承全局默认",
      deadbandInvalid: "请输入有效的 deadband 数值（>= 0）。",
      ...
      riskAuditTitle: "风控审计",
      riskAuditSource: "审计来源",
      riskAuditEquitySource: "净值口径",
      riskAuditCashflow: "现金流校正",
      riskAuditDdAll: "全局回撤",
      riskAuditDd52w: "52周回撤",
      riskAuditLockState: "回撤锁状态",
      riskAuditLockOn: "锁定",
      riskAuditLockOff: "未锁定",
      riskAuditCurrencyPnl: "分币种 PnL",
      riskAuditReason: "触发原因详情",
      riskAuditThresholds: "阈值快照",
      riskAuditTriggers: "触发明细",
      riskAuditGuardState: "Guard 状态快照",
      runProgressAt: "最近进度时间",
      runProgressStage: "进度阶段",
      runProgressReason: "进度说明",
      runIntentMismatchTitle: "订单意图与创建订单不一致",
      runIntentMismatchSummary: "缺失 {missing} / 多余 {extra}",
      runIntentMismatchPath: "意图文件 {path}",
      runIntentMismatchMissing: "缺失标的",
      runIntentMismatchExtra: "多余标的",
      runIntentMismatchEmpty: "未提供标的明细",
      runStalledAt: "停滞时间",
      runStalledReason: "停滞原因",
      runStalledHint: "已进入停滞状态，请选择同步/继续/终止。",
      runAction: {
        sync: "同步状态",
        resume: "继续运行",
        terminate: "终止批次",
      },
      runActionReason: "处置原因",
      runActionReasonHint: "可选，写入审计说明",
      runActionMissing: "请选择批次后再操作",
      runActionError: "批次操作失败",
      runActionSuccess: "{action} 已提交",
      createRun: "生成交易批次",
      createRunSuccess: "交易批次已生成",
      createRunError: "交易批次生成失败",
      detailRefresh: "刷新明细",
      detailError: "批次明细加载失败",
      symbolSummaryTitle: "目标偏离概览",
      symbolSummaryMeta: "目标权重与当前持仓偏离对比",
      symbolSummaryUpdatedAt: "明细更新时间",
      symbolSummaryCount: "标的总数",
      ...
      orderCancel: "撤单",
      orderCancelPending: "撤单中",
      orderCancelConfirm: "确认撤销订单 #{id} {symbol} {side} {qty} ({type})？",
      orderCancelSuccess: "撤单请求已提交（#{id}）",
      orderCancelError: "撤单请求失败",
      orderType: {
        mkt: "MKT 市价",
        lmt: "LMT 限价",
        adaptiveLmt: "Adaptive LMT(IBKR)",
        pegMid: "PEG MID",
      },
      receiptsTitle: "回执",
      receiptsLoadError: "回执加载失败",
      receiptsEmpty: "暂无回执记录",
      receiptWarning: {
        leanLogsMissing: "未找到 Lean 日志",
        leanLogsReadError: "读取 Lean 日志失败",
        leanLogsParseError: "解析 Lean 日志失败",
      },
      receiptKind: {
        order: "订单",
        fill: "成交",
  ...
  en: {
    ...
    projects: {
      ...
      config: {
        ...
        feeBps: "Backtest Fee (bps)",
        feeBpsHint: "Leave blank to inherit global default",
    ...
    strategy: {
      ...
      decision: {
        ...
        backtestRunId: "Backtest Run ID",
        backtestRunIdHint: "Optional, override backtest trace",
        preview: "Preview",
        ...
        backtestLinkStatus: "Backtest link",
        backtestUnlinked: "Unlinked",
        scorePath: "Score file",
        ...
        history: {
          ...
          meta: "Filter and trace historical decision snapshots",
          filters: {
            status: "Status",
            backtestRunId: "Backtest Run ID",
            backtestRunIdHint: "Filter by backtest trace",
            snapshotDate: "Snapshot date",
            all: "All",
          },
          snapshotDate: "Snapshot date",
          ...
          detailEmpty: "Select a snapshot to view details",
          selectedCount: "Selected",
          riskOff: "Risk gate",
        },
      },
      pipeline: {
        ...
        backtest: {
          ...
          fields: {
            ...
            riskOffLookbackDays: "Momentum Lookback (days)",
            ...
            coldStartTurnover: "Cold Start Turnover",
          ...
          hints: {
            ...
            coldStartTurnover: "Turnover cap when starting from cash",
    ...
    data: {
      ...
      excludes: {
        title: "Global Exclude List",
        meta: "Unified excludes for PreTrade / backtest / live trade / data sync",
        hint: "The exclude list applies automatically to downstream jobs.",
        add: "Add",
        save: "Save",
        enable: "Enable",
        disable: "Disable",
        ...
        enabled: "Enabled",
        disabled: "Disabled",
        loading: "Loading excludes...",
        empty: "No excludes yet",
        error: "Failed to load excludes",
        errorSymbol: "Symbol is required",
        placeholderSymbol: "e.g. AAPL",
      ...
      backtest: {
        settings: {
          title: "Backtest Defaults",
          meta: "Global defaults for initial cash and fees; project-level overrides apply.",
          initialCash: "Default Initial Cash",
          initialCashHint: "e.g. 30000",
          feeBps: "Default Fee (bps)",
          feeBpsHint: "e.g. 10",
          settingsSaved: "Backtest defaults saved",
          settingsLoadError: "Failed to load backtest defaults",
          settingsSaveError: "Failed to save backtest defaults",
          settingsInvalidCash: "Initial cash must be positive",
          settingsInvalidFee: "Fee must be non-negative",
      ...
      pretrade: {
        ...
        stepsDesc: {
          ...
          bridge_gate: "Validate bridge heartbeat/account/positions/quotes",
          market_snapshot: "Pre-trade market snapshot (Lean bridge)",
          trade_execute: "Execute trade run (Paper/Live)",
        ...
        stepsGroup: {
          ...
          trade: "Trade gate & execute",
          tradeHint: "Lean bridge readiness + order execution",
          audit: "Audit & fallback",
          auditHint: "Post-trade audit and fallback records",
          other: "Other steps",
      ...
      ib: {
        ...
        workstationTypeHint: "Select endpoint type: TWS or IB Gateway",
        workstationTypeTws: "TWS",
        workstationTypeGateway: "IB Gateway",
        clientId: "Client ID",
    ...
    trade: {
      ...
      pipeline: {
        ...
        detailMeta: "Timeline and event details",
        drawerTitle: "Event Detail",
        drawerEmpty: "Select an event to view details",
        drawerLabelType: "Type",
        drawerLabelId: "ID",
        drawerLabelStatus: "Status",
        drawerLabelError: "Error code",
        drawerLabelLog: "Log path",
        drawerLabelTags: "Tags",
        empty: "No pipeline runs",
        detailEmpty: "Select a run to view events",
        projectRequired: "Select a project first",
        stages: {
          data: "Data Prep",
          snapshot: "Snapshot",
          pretrade: "Pretrade Gate",
          trade: "Trade Execute",
          audit: "Audit",
        },
        filters: {
        ...
        actions: {
          ...
          retryStepSuccess: "Step retry requested",
          resumeSuccess: "Run resume requested",
          executeSuccess: "Trade execution requested",
        },
        errors: {
          loadRuns: "Failed to load pipeline runs",
          loadDetail: "Failed to load pipeline detail",
          actionFailed: "Pipeline action failed",
        },
      },
      mainSectionTitle: "Core Panels",
      advancedSectionTitle: "Advanced Panels",
      refreshAll: "Refresh All",
      statusExplainTitle: "Status Notes",
      statusExplainConnection: "Connection",
      statusExplainDataSource: "Data Source",
      statusExplainRefresh: "Refresh",
      statusExplainHeartbeatAge: "Heartbeat age {seconds}s",
      statusExplainLastHeartbeat: "Heartbeat at {time}",
      statusExplainLastRefresh: "Last refresh {time}",
      statusExplainNextAllowed: "Next allowed refresh {time}",
      statusReason: {
        bridgeStale: "Lean Bridge heartbeat timeout",
        bridgeIssue: "Lean Bridge issue detected",
        unknown: "Unknown reason",
      },
      refreshHint: {
        rateLimited: "Refresh requests are throttled due to high frequency.",
        fresh: "Current status is fresh; refresh skipped.",
        failed: "Refresh failed. Please try again later.",
        generic: "Refresh result: {result} (reason: {reason}).",
      },
      autoUpdateLabel: "Auto update",
      autoUpdateOn: "On",
      autoUpdateOff: "Paused",
      refreshInterval: "Interval",
      refreshNext: "Next refresh",
      refreshLast: "Last refresh",
      refreshManual: "Manual",
      bridgeStatusTitle: "Lean Bridge Status",
      bridgeStatusMeta: "Bridge heartbeat and refresh control",
      bridgeStatusLabel: "Bridge Status",
      bridgeHeartbeatAt: "Last heartbeat",
      bridgeStaleLabel: "Stale",
      bridgeLastRefreshAt: "Last refresh",
      bridgeRefreshResultLabel: "Refresh result",
      bridgeRefreshReasonLabel: "Refresh reason",
      bridgeRefreshMessageLabel: "Refresh note",
      bridgeLastError: "Last error",
      bridgeRefreshButton: "Refresh Lean Bridge",
      bridgeRefreshRunning: "Refreshing",
      bridgeAutoRefreshOn: "Auto refresh: on",
      bridgeAutoRefreshOff: "Auto refresh: off",
      bridgeStatusLoadError: "Failed to load bridge status",
      gatewayRuntimeLabel: "Gateway Runtime",
      gatewayProbeResultLabel: "Direct Probe",
      gatewayProbeLatencyLabel: "Probe Latency",
      gatewayProbeLatencyValue: "{value} ms",
      gatewayRecoveryActionLabel: "Last Recovery Action",
      gatewayRecoveryAtLabel: "Last Recovery Time",
      ...
      gatewayRuntimeState: {
        ...
        command_stuck: "Command Stuck",
        bridge_degraded: "Bridge Degraded",
      ...
      gatewayRecoveryAction: {
        none: "None",
        bridge_refresh: "Refresh Bridge",
        leader_restart: "Restart Leader",
      ...
      bridgeRefreshReason: {
        ...
        rate_limited: "Rate limited",
        lock_busy: "Lock busy",
        script_missing: "Missing script",
        fresh: "Already fresh",
      },
      bridgePoolTitle: "Lean Bridge Pool",
      bridgePoolMeta: "Leader/Worker executor overview",
      bridgePoolMode: "Mode",
      bridgePoolRefresh: "Refresh Pool",
      bridgePoolEmpty: "No executors",
      bridgePoolError: "Failed to load pool status",
      bridgePoolColumns: {
        role: "Role",
        clientId: "Client ID",
        status: "Status",
      ...
      marketHealthTitle: "Market Data Health",
      marketHealthMeta: "Stream and quote snapshot health overview",
      marketHealthStatus: "Health Status",
      marketHealthUpdatedAt: "Heartbeat",
      ...
      accountPositionsStaleHint:
        "Positions are empty and data is stale. Lean Bridge may not be updating. Check Lean status or use “Refresh All”.",
      accountPositionsStaleUpdatedAt: "Bridge heartbeat",
      accountPositionsTrustedFallbackHint:
        "Showing the last trusted positions. Gateway recovery is still in progress, or the latest positions refresh failed.",
      ...
      positionChartFallbackBadge: "Fallback",
      positionChartFallbackHint: "Showing local daily fallback data.",
      positionChartGatewayFallbackHint:
        "Gateway recovery is in progress. The chart has switched to local daily fallback.",
      ...
      positionTable: {
        ...
        realizedMissing: "Not reported",
        account: "Account",
        currency: "Currency",
        actions: "Actions",
      },
      positionActionSelected: "{count} selected",
      positionActionSelectAll: "Select all positions",
      positionActionSelectSymbol: "Select {symbol}",
      positionActionBuy: "Buy",
      positionActionSell: "Sell",
      positionActionClose: "Close",
      positionActionQtyShort: "Qty",
      positionActionSessionShort: "Session",
      positionActionTypeShort: "Type",
      positionActionLimitShort: "Limit",
      positionActionLimitShortPlaceholder: "Last",
      positionActionLimitDisabledTitle: "Editable for limit-style orders only",
      positionActionBatchClose: "Batch Close",
      positionActionLiquidateAll: "Liquidate All",
      manualSession: {
        rth: "Regular Hours",
        pre: "Pre-market",
        post: "After-hours",
      ...
      positionLimitPricePlaceholder: "Limit price (defaults to latest quote)",
      positionOrderConfirm: "Confirm market {side} {qty} shares of {symbol}?",
      positionOrderConfirmLimit:
        "Confirm limit {side} {qty} shares of {symbol} at {price} ({session})?",
      positionBatchCloseConfirm: "Confirm batch close for {count} positions?",
      ...
      decisionBasisEffectivePitDate: "Effective PIT Date",
      decisionBasisLatestPitDate: "Latest Available PIT Date",
      decisionBasisFallbackUsed: "PIT Fallback Used",
      decisionBasisFallbackReason: "PIT Fallback Reason",
      decisionBasisStaleWarning: "Snapshot Staleness Warning",
      decisionBasisAgeDays: "PIT Age (days)",
      decisionBasisStaleThreshold: "threshold {days}d",
      decisionBasisAsOfTime: "Decision As-Of Time",
      decisionBasisNoFallback: "No fallback",
      decisionBasisAgeDaysShort: "{days}d",
      decisionBasisSummaryLine:
        "Decision path: requested {requested} -> effective {effective} (latest {latest}); fallback: {fallback}; age: {age}",
      decisionBasisFallbackReasonCode: {
        pit_snapshot_unavailable: "No PIT snapshot available",
        requested_snapshot_unavailable_use_previous:
          "Requested date unavailable; fallback to nearest previous PIT snapshot",
        requested_snapshot_before_first_available:
          "Requested date before first available snapshot; fallback to earliest PIT snapshot",
      },
      ...
      weeklyRebalance: {
        title: "Weekly Auto Rebalance",
        meta: "Inspect timers, PreTrade checks, and trade run linkage; manual starts are supported.",
        force: "Force past date/session guards",
        dryRun: "Dry run execution",
        projectRequired: "Select a project first.",
        loadError: "Failed to load weekly rebalance status",
        actionError: "Failed to trigger weekly rebalance",
        confirmExecute:
          "Confirm manual weekly rebalance execution? This will submit the execution workflow.",
        manualPrepare: "Run PreTrade Manually",
        manualExecute: "Execute Trade Manually",
        actionResult:
          "{phase} returned {status} · PreTrade {pretrade} · Trade {trade} · {message}",
        updatedAt: "Status refreshed {at}",
        phase: {
          prepare: "PreTrade",
          execute: "Execute",
        },
      ...
      tradeSettingsSave: "Save Trade Settings",
      tradeSettingsSaved: "Trade settings saved",
      tradeSettingsSaveError: "Failed to save trade settings",
      deadbandGlobalNotional: "Global deadband min notional",
      deadbandGlobalNotionalHint:
        "Rebalance orders below this notional will be filtered (0 disables).",
      deadbandGlobalWeight: "Global deadband min weight delta",
      ...
      riskAuditTitle: "Risk Audit",
      riskAuditSource: "Audit Source",
      riskAuditEquitySource: "Equity Source",
      riskAuditCashflow: "Cashflow Adjustment",
      riskAuditDdAll: "All-time Drawdown",
      riskAuditDd52w: "52-week Drawdown",
      riskAuditLockState: "Drawdown Lock",
      riskAuditLockOn: "Locked",
      riskAuditLockOff: "Unlocked",
      riskAuditCurrencyPnl: "PnL by Currency",
      riskAuditReason: "Reason Details",
      riskAuditThresholds: "Threshold Snapshot",
      riskAuditTriggers: "Trigger Details",
      riskAuditGuardState: "Guard State Snapshot",
      runProgressAt: "Last Progress At",
      runProgressStage: "Progress Stage",
      runProgressReason: "Progress Note",
      runIntentMismatchTitle: "Intent vs Order Mismatch",
      runIntentMismatchSummary: "Missing {missing} / Extra {extra}",
      runIntentMismatchPath: "Intent file {path}",
      runIntentMismatchMissing: "Missing symbols",
      runIntentMismatchExtra: "Extra symbols",
      runIntentMismatchEmpty: "No symbol details provided",
      runStalledAt: "Stalled At",
      runStalledReason: "Stalled Reason",
      runStalledHint: "Run is stalled. Choose sync/resume/terminate.",
      runAction: {
        sync: "Sync Status",
        resume: "Resume Run",
        terminate: "Terminate Run",
      },
      runActionReason: "Action Reason",
      runActionReasonHint: "Optional, saved to audit logs",
      runActionMissing: "Select a run before taking action",
      runActionError: "Run action failed",
      runActionSuccess: "{action} submitted",
      createRun: "Create Trade Run",
      createRunSuccess: "Trade run created",
      createRunError: "Failed to create trade run",
      detailRefresh: "Refresh Details",
      detailError: "Failed to load run details",
      symbolSummaryTitle: "Target Deviation Summary",
      symbolSummaryMeta: "Compare target weights with current holdings",
      symbolSummaryUpdatedAt: "Details updated",
      symbolSummaryCount: "Total Symbols",
      ...
      orderCancel: "Cancel",
      orderCancelPending: "Canceling",
      orderCancelConfirm: "Cancel order #{id} {symbol} {side} {qty} ({type})?",
      orderCancelSuccess: "Cancel request submitted (#{id})",
      orderCancelError: "Cancel request failed",
      orderType: {
        mkt: "MKT",
        lmt: "LMT",
        adaptiveLmt: "Adaptive LMT (IBKR)",
      ...
      receiptsLoadError: "Failed to load receipts",
      receiptsEmpty: "No receipts yet",
      receiptWarning: {
        leanLogsMissing: "Lean logs not found",
        leanLogsReadError: "Failed to read Lean logs",
        leanLogsParseError: "Failed to parse Lean logs",
      },
      receiptKind: {
        order: "Order",
        fill: "Fill",
