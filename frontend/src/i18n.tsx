    ...
    data: {
      ...
      pretrade: {
        ...
        settings: {
          ...
          note: "Leave token empty to keep current config",
        },
        telegram: {
        ...
        templates: {
          ...
          activeTag: "Active",
          actions: "Actions",
          hint: "Optional: pass {\"steps\": [...]} to override defaults",
          empty: "No templates",
        },
      },
      bulk: {
