...
class TrendMomentumDefensive(QCAlgorithm):
    def initialize(self) -> None:
        ...
        self.target_positions = int(selection.get("top_n", 20))
        self.max_position = float(risk_params.get("max_position", 0.08))
    ...
    def rebalance(self) -> None:
        ...
        target_weight = min(1.0 / len(selected), self.max_position)
        ...
        self._clear_defensive(selected_set)
